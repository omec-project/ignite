...
try:
    ...
    s1.sendS1ap('authentication_failure', uplinknastransport_auth_failure, enbues1ap_id, nas_authentication_failure)
    ...
    print ("\n-------------------------------------\nIMSI Attach,,Auth Failure Detach Execution Successful\n---------------------------------------")
