...
try:
    ...
    print ("\n---------------------------------------------\nIMSI Attach and HSS Detach Execution Started\n-----------------------------------------------")
    ...
    s1.sendS1ap('detach_accept', uplinknastransport_detach_accept, enbues1ap_id, nas_detach_accept)
    ...
    print ("\n---------------------------------------------\nIMSI Attach and HSS Detach Execution Successful\n-----------------------------------------------")
