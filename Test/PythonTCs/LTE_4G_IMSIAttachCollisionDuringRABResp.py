...
try:
    ...
    print ("\n-------------------------------------\nIMSI Attach Collision during Release Access Bearer Response - Execution Started\n---------------------------------------")
    ...
    print ("\n-------------------------------------\nIMSI Attach Collision during Release Access Bearer Response - Execution Successful\n---------------------------------------")
