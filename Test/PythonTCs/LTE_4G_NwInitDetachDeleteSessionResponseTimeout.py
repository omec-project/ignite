...
try:
    ...
    print ("\n---------------------------------\nNetwork Initated Detach Delete Session Response Timeout Execution Started\n------------------------------")
    ...
    nit_ctxt_setup_req=s1.receiveS1ap()
    ...
    print ("\n---------------------------------\nNetwork Initated Detach Delete Session Response Timeout Execution Successful\n------------------------------")
