...
try:
    ...
    protocol_ula_failure, msg_data_ula_failure = icu.loadMessageData("../MessageTemplates/Diameter/ula_exp_failure.json")
    ...
    print ("\n-------------------------------------\nULA Exp Result Code Failure Execution Successful\n---------------------------------------")
