...
try:
    ...
    s1.sendS1ap('securitymode_complete', uplinknastransport_securitymode_complete, enbues1ap_id,
                nas_securitymode_complete)
    ...
    s1.sendS1ap('esm_information_response', uplinknastransport_esm_information_response, enbues1ap_id,
    ...
    num_of_processed_sec_mode_resp_afattach = int(
        do.splitProcStats(proc_stat_af_attach, stats_type["processed_sec_mode"]))
    ...
    icu.grpcValidation(num_of_del_session_resp + 1, num_of_del_session_resp_sent_Afdetach,
                       "Number of Deleted Session Request")
    ...
    print(
        "\n-------------------------------------\nIMSI Attach-TAU-Detach Execution Successful\n---------------------------------------")
