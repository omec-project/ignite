...
try:
    ...
    protocol_ula_failure, msg_data_ula_failure = icu.loadMessageData("../MessageTemplates/Diameter/ula_failure.json")
    ...
    print ("\n-------------------------------------\nULA Result Code Failure Execution Started\n---------------------------------------")
    ...
    ds.sendS6aMsg('update_location_response', msg_data_ula_failure, imsi)

    igniteLogger.logger.info("\n---------------------------------------\nULA Result Code Failure\n---------------------------------------")
    time.sleep(5)

    igniteLogger.logger.info("\n---------------------------------------\nAttach Reject received from MME\n---------------------------------------")
    s1.receiveS1ap()

    igniteLogger.logger.info("\n---------------------------------------\nUE Context Release Command received from MME\n---------------------------------------")
    s1.receiveS1ap()
    ...
    print ("\n-------------------------------------\nULA Result Code Failure Execution Successful\n---------------------------------------")
