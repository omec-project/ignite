...
try:
    ...
    print ("\n-------------------------------------\nIMSI Attach,HO Prep Failure Detach Execution Started\n---------------------------------------")
    ...
    s1.sendS1ap('handover_request_neg_acknowledge', handover_negative_acknowledge, enbues1ap_id)

    igniteLogger.logger.info("\n---------------------------------------\neNB receives UE Context Release Request from MME\n---------------------------------------")
    s1.receiveS1ap(target=True)

    igniteLogger.logger.info("\n---------------------------------------\nHandover Preparation Failure received from MME to eNB\n---------------------------------------")
    s1.receiveS1ap()
    ...
    print ("\n-------------------------------------\nIMSI Attach,HO Prep Failure Detach Execution Successful\n---------------------------------------")
