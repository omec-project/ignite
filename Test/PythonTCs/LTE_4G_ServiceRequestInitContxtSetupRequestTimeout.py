...
try:
    ...
    print("\n---------------------------------------\nService Request Initiated Context Setup Request Timeout Execution Started\n---------------------------------------")
    ...
    igniteLogger.logger.info("\n---------------------------------------\nInitial Context Setup Response Timeout\n---------------------------------------")
    time.sleep(5)
    ...
    print("\n---------------------------------------\nService Request Initiated Context Setup Request Timeout Execution Successful\n---------------------------------------")
