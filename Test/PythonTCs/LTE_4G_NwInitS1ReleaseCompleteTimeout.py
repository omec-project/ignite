...
try:
    ...
    print("\n---------------------------------------\nNetwork Initiated S1Release Timeout Execution Started\n---------------------------------------")
