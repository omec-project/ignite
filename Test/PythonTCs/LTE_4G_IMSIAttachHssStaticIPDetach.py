...
try:
    ...
    served_party_ip_address=icu.getKeyValueFromDict(msg_data_ula,"served-party-ip-address")[0]
    ...
    icu.validateProtocolIE(cs_req,'prefix_and_ipv4address',served_party_ip_address)
	
    icu.updateKeyValueInDict(create_session_response,"prefix_and_ipv4address",served_party_ip_address)
    ...
    ipv4 = served_party_ip_address.split('.')
    ipv4_1 = ipv4[0]
    ipv4_2 = ipv4[1]
    ipv4_3 = ipv4[2]
    ipv4_4 = ipv4[3]	
    icu.validateProtocolIE(init_ctxt_setup_req,'pdn_ipv4_1',int(ipv4_1))
    icu.validateProtocolIE(init_ctxt_setup_req,'pdn_ipv4_2',int(ipv4_2))
    icu.validateProtocolIE(init_ctxt_setup_req,'pdn_ipv4_3',int(ipv4_3))
    icu.validateProtocolIE(init_ctxt_setup_req,'pdn_ipv4_4',int(ipv4_4))
    ...
    print ("\n-------------------------------------\nIMSI Attach Static IP Detach Execution Successful\n---------------------------------------")
