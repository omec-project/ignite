...
try:
    ...
    print ("\n-------------------------------------\nDiamter Auth Reject Response Excecution Started Started\n---------------------------------------")
    ...
    ds.sendS6aMsg('authentication_info_response', msg_data_aia_reject,imsi)
    
    igniteLogger.logger.info("\n---------------------------------------\nDIAMETER AUTHENTICATION REJECTED\n---------------------------------------")
    time.sleep(5)
    
    igniteLogger.logger.info ("\n---------------------------------------\nAttach Reject for DIAMETER AUTHENTICATION\n-----------------------------------------")
    s1.receiveS1ap()
    ...
    print("\n-------------------------------------\nDiamter Auth Reject Response Excecution Successful\n---------------------------------------")
