...
try:
    ...
    print ("\n-------------------------------------\nGUTI Attach Collision during Release Access Bearer Response - Execution Started\n---------------------------------------")
    ...
    igniteLogger.logger.info("\n---------------------------------------\nAttach Request received while waiting for Release Access Bearer Response\n---------------------------------------")
    ...
    icu.grpcValidation(ue_count_before_attach + 1, ue_count_after_detach, "Number of Subs Attached After Detach")
    ...
    print ("\n-------------------------------------\nGUTI Attach Collision during Release Access Bearer Response - Execution Successful\n---------------------------------------")
