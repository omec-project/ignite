...
try:
    ...
    igniteLogger.logger.info("\n---------------------------------------\nHandover Failure sent from target eNB to MME\n---------------------------------------")
    s1.sendS1ap('handover_failure', handover_failure, enbues1ap_id)

    igniteLogger.logger.info("\n---------------------------------------\nHandover Preparation Failure received from MME to target eNB\n---------------------------------------")
    s1.receiveS1ap()
