...
try:
    ...
    num_of_erab_mod_ind_timeout = int(do.splitProcStats(proc_stat, stats_type["erab_mod_ind_timeout"]))
    num_of_abort_erab_mod_ind = int(do.splitProcStats(proc_stat, stats_type["abort_erab_mod_ind"]))
    ...
    igniteLogger.logger.info ("\n-------------------------------------\nS11 Modify Bearer Response Delay Timeout\n---------------------------------------")
    time.sleep(5)
    ...
    num_of_erab_mod_ind_timeout_af_detach = int(do.splitProcStats(proc_stat_af_detach, stats_type["erab_mod_ind_timeout"]))
    icu.grpcValidation(num_of_erab_mod_ind_timeout + 1, num_of_erab_mod_ind_timeout_af_detach, "Number of ERAB Modification Indication Timeout")

    num_of_abort_erab_mod_ind_af_detach = int(do.splitProcStats(proc_stat_af_detach, stats_type["abort_erab_mod_ind"]))
    icu.grpcValidation(num_of_abort_erab_mod_ind + 1, num_of_abort_erab_mod_ind_af_detach, "Number of Abort ERAB Modification Indication")

    print ("\n-------------------------------------\n ERAB Mod Ind - Modify Bearer Response Timeout Execution Successful\n---------------------------------------")
