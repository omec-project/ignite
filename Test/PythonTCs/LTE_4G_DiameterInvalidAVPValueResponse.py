...
try:
    ...
    print ("\n-------------------------------------\nDiamter AVP Value Response Excecution Started Started\n---------------------------------------")
    ...
    ds.sendS6aMsg('update_location_reject', msg_data_ula_reject, imsi)
    
    clr_flag=True
    
    igniteLogger.logger.info("\n---------------------------------------\nDIAMETER INVALID AVP VALUE RESPONSE\n---------------------------------------")
    time.sleep(5)
    
    igniteLogger.logger.info ("\n---------------------------------------\nAttach Reject for DIAMETER INVALID AVP VALUE RESPONSE\n-----------------------------------------")
    s1.receiveS1ap()
    ...
    ue_count_after_attach = do.splitProcStats(proc_stat_af_attach, stats_type["subs_attached"])
    ...
    print("\n-------------------------------------\nDiamter AVP Value Response Excecution Successful\n---------------------------------------")
