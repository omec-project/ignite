...
*** Test Cases ***
TC1: LTE 4G UE Init Delete Session Response Timeout
    [Documentation]    UE Init Delete Session Response Timeout
    [Tags]    TC1    LTE_4G_UE_Init_Delete_Session_Response_Timeout    Attach    Detach
