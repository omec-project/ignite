...
*** Test Cases ***
TC1: LTE 4G Release Access Bearer Response Timeout
    [Documentation]    Timeout Scenario of Release Access Bearer Response
    [Tags]    TC1    LTE_4G_Release_Access_Bearer_Response_Delay    Attach    Detach
