...
*** Test Cases ***
TC1: LTE 4G Service Request Modify Bearer Response Timeout
    [Documentation]    Service Request Modify Bearer Response Timeout
    [Tags]    TC1    LTE_4G_Service_Request_Modify_Bearer_Response_Timeout    Attach    Detach
