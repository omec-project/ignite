...
*** Test Cases ***
TC1: LTE 4G S1ap Initial Context Setup Response Delay
    [Documentation]    Timeout Scenario of Initial Context Setup Response
    [Tags]    TC1    LTE_4G_Initial_Context_Setup_Response_Delay    Attach    Detach
