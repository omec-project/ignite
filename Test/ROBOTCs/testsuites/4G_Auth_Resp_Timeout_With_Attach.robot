...
*** Test Cases ***
TC1: LTE 4G Auth Response Delay With Attach
    [Documentation]    Timeout Scenario For Auth Response Delay With Reattach
    [Tags]    TC1    LTE_4G_Auth_Response_Delay_With_Attach    Attach    Detach
