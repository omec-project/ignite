...
*** Test Cases ***
TC1: LTE 4G S1 Release Release Timeout Scenario
    [Documentation]    LTE_4G_S1 Release Timeout scenario
    [Tags]    TC1    LTE_4G_S1_Release_Release_Timeout    Attach    Detach
    ...
    ${ueCtxtreleaseTimeoutCountAfTimeout}    Get GRPC Stats Response Count    ${procStatOutAfTimeout}    ${num_of_ue_ctxt_rel_comp_timeout}
    ${ueCtxtreleaseTimeoutCountAfTimeout}    Convert to Integer    ${ueCtxtreleaseTimeoutCountAfTimeout}
    ${incrementueCtxtreleaseTimeoutCountAfTimeout}    Evaluate    ${ueCtxtreleaseTimeoutCountBf}+1
    Should Be Equal    ${incrementueCtxtreleaseTimeoutCountAfTimeout}    ${ueCtxtreleaseTimeoutCountAfTimeout}    Expected S1 Release Complete Timeout Count: ${incrementueCtxtreleaseTimeoutCountAfTimeout}, but S1 Release Complete Timeout Count: ${ueCtxtreleaseTimeoutCountAfTimeout}    values=False
