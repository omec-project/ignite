...
*** Test Cases ***
TC1: LTE 4G Nw Init Detach Delete Session Response Timeout
    [Documentation]    Attach Detach success scenario for LTE 4G IMSI
    [Tags]    TC1    LTE_4G_Nw_Init_Detach_Delete_Session_Response_Timeout    Attach    Detach
    ...
    ${detReq}    Receive S1ap    #MME send Detach Accept to UE
