...
*/}}
{{- define "ignite.diameter_endpoint" -}}
{{- $service := index . 0 -}}
{{- $type := index . 1 -}}
{{- $context := index . 2 -}}
{{- if eq $type "identity" -}}
...
metadata:
  ...
  labels:
{{ tuple $saName $context | include "ignite.metadata_labels" | indent 4 }}
---
