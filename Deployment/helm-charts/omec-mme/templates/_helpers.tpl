...
*/}}
{{- define "omec-mme.metadata_labels" -}}
{{- $application := index . 0 -}}
{{- $context := index . 1 -}}
...
*/}}
{{- define "omec-mme.diameter_endpoint" -}}
{{- $service := index . 0 -}}
{{- $type := index . 1 -}}
{{- $context := index . 2 -}}
{{- if eq $type "identity" -}}
...
*/}}
{{- define "omec-mme.service_account" -}}
{{- $context := index . 1 -}}
{{- $saName := index . 0 -}}
...
metadata:
  ...
  labels:
{{ tuple $saName $context | include "omec-mme.metadata_labels" | indent 4 }}
---
